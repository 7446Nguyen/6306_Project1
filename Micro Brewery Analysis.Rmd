...
# Get raw data
Beers <- read.csv("C:\\Data\\GitRepos\\6306_Project1\\Beers.csv")
Breweries <- read.csv("C:\\Data\\GitRepos\\6306_Project1\\Breweries.csv")
```
...
Six regions were created by grouping the states into them. An ANOVA(ANalysis Of VAriance) was performed by region. This test looks for statistically significant differences in IBU and ABV by region.
